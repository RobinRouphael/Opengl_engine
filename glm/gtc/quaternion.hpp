...
#		endif
	...
	/// The interpolation is oriented and the getRotation is performed at constant speed.
	...
	/// Spherical linear interpolation of two quaternions.
	/// The interpolation always take the short path and the getRotation is performed at constant speed.
	/// 
	/// @param x A quaternion
	/// @param y A quaternion
	/// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
	...
	/// @param axis Axis of the getRotation
	/// 
	/// @see gtc_quaternion
	template<typename T, precision P>
	...
	/// Returns the quaternion getRotation angle.
	///
	/// @see gtc_quaternion
	template<typename T, precision P>
	GLM_FUNC_DECL T angle(tquat<T, P> const & x);

	/// Returns the q getRotation axis.
	///
	/// @see gtc_quaternion
	template<typename T, precision P>
