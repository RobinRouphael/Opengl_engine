...
QT_MOC_LITERAL(5, 45, 18) // "setTextureFromFile"

    },
    "SphereWidget\0stacksEdited\0\0val\0"
    "sectorsEdited\0setTextureFromFile"
};
...
void SphereWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SphereWidget *_t = static_cast<SphereWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stacksEdited((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sectorsEdited((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setTextureFromFile(); break;
        default: ;
        }
    }
}

const QMetaObject SphereWidget::staticMetaObject = {
    { &ModelInterface::staticMetaObject, qt_meta_stringdata_SphereWidget.data,
      qt_meta_data_SphereWidget,  qt_static_metacall, nullptr, nullptr}
};
