...
void LightInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LightInterface *_t = static_cast<LightInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LightInterface::*_t)();
...
const QMetaObject LightInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LightInterface.data,
      qt_meta_data_LightInterface,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PointLightWidget *_t = static_cast<PointLightWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PointLightWidget::staticMetaObject = {
    { &LightInterface::staticMetaObject, qt_meta_stringdata_PointLightWidget.data,
      qt_meta_data_PointLightWidget,  qt_static_metacall, nullptr, nullptr}
};
